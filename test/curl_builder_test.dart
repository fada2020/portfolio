...
void main() {
  ApiEndpoint ep({String method = 'GET', String path = '/v1/things/{id}', List<ApiParameter> params = const [], Map<String, dynamic>? req}) =>
      ApiEndpoint(method: method, path: path, parameters: params, requestBodySchema: req);
  ...
  test('buildCurl adds auth header and body', () {
    final e = ep(method: 'POST', req: const {
      'type': 'object',
